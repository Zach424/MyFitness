...
- [架构决策 0044](docs/architecture/decisions/0044-stable-record-list-pagination.md)
- [架构决策 0045](docs/architecture/decisions/0045-stable-revision-history-pagination.md)
- [架构决策 0046](docs/architecture/decisions/0046-stable-definition-history-pagination.md)
- [架构决策 0047](docs/architecture/decisions/0047-stable-weekly-plan-history-pagination.md)
...
- [第 46 轮档案](docs/iterations/046-stable-record-list-pagination.md)
- [第 47 轮档案](docs/iterations/047-stable-revision-history-pagination.md)
- [第 48 轮档案](docs/iterations/048-stable-definition-history-pagination.md)
- [第 49 轮档案](docs/iterations/049-stable-weekly-plan-history-pagination.md)
...
- [第 54 轮档案](docs/iterations/054-workout-meal-save-recovery.md)
...
- [渐进记录历史移动端证据](output/playwright/iteration-046-progressive-history-mobile.png)
- [渐进版本历史移动端证据](output/playwright/iteration-047-progressive-revisions-mobile.png)
- [渐进定义历史移动端证据](output/playwright/iteration-048-progressive-definition-revisions-mobile.png)
- [渐进周计划历史移动端证据](output/playwright/iteration-049-progressive-plan-revisions-mobile.png)
- [懒加载自定义动作注册页移动端证据](output/playwright/iteration-050-lazy-exercise-catalog-mobile.png)
- [懒加载餐食照片校样台移动端证据](output/playwright/iteration-051-lazy-food-photo-mobile.png)
- [懒加载餐食照片校样台宽屏证据](output/playwright/iteration-051-lazy-food-photo-wide.png)
...
- [训练响应丢失恢复移动端证据](output/playwright/iteration-054-workout-save-recovery-mobile.png)
- [饮食响应丢失恢复移动端证据](output/playwright/iteration-054-meal-save-recovery-mobile.png)
