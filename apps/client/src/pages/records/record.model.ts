...
export {
  classifyReadFailure as classifyRecordReadFailure,
  snapshotReadPhase as recordReadPhase,
} from '../../lib/read-authority'

export type RecordReadFailureKind = ReadFailureKind

export type RecordReadPhase = SnapshotReadPhase
