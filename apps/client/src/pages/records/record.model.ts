...
export type RecordReadFailureKind = 'offline' | 'refused' | 'service' | 'unknown'

export type RecordReadPhase = 'initial-loading' | 'ready' | 'refreshing' | 'initial-error' | 'stale'
...
export const classifyRecordReadFailure = (error: unknown): RecordReadFailureKind => {
