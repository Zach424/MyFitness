...
- 六份活跃权威文档必须保留约定的中文一级、二级导航标题；
- `docs/PROJECT_STATUS.md`、`docs/product/PRODUCT_BRIEF.md`、`docs/product/ROADMAP.md`、`docs/architecture/ARCHITECTURE.md`、`docs/operations/USER_IDENTITY_RUNBOOK.md` 和 `docs/DOCUMENTATION_MIGRATION_INDEX.md` 排除代码与链接后的中文占比均不得低于 72%，且不得存在包含三个及以上英文单词而完全没有汉字的纯英文叙述行；围栏代码块不参与逐行判断；
