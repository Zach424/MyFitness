...
| R-032 | 个人状态证据账本可能被误解为完整、实时或统一的个人真相                          | 高   | 固定知识类别、权威来源、快照时间、无保证有效期和失效原因；来源入口、显式刷新与发生时间上界均不冒充完整或双时态知识历史。封闭测试前仍须用真实用户验证类别、遗漏和时效理解        |
