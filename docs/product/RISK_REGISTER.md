...
第 101 轮仅复核 R-009 的本地包体证据；第 102 轮新增 R-030，以记录主观恢复估计尚未完成真实纵向校准；第 103 轮新增 R-031，并按结果回看的实际 WeApp 交付成本重基线本地包体预算；第 104–105 轮复核 R-009/R-031，历史与独立结果页保持非因果。第 106 轮再次复核 R-009/R-031：用户确认体验与系统观察分开且不进入自动适应，但 WeApp 总包只余 5 字节，第 107 轮必须先做结构减重。全表最近一次完整审阅仍是上述第 043 轮。
...
| R-009 | H5 入口仍超过 webpack 建议警告值，双端包体余量仍需持续保护                      | 中   | H5/WeApp 入库预算、照片用途路由拆分和异步公共块已通过；WeApp 已达 1,109,995/1,110,000 字节，第 107 轮必须先做结构减重且不得提高预算；封闭测试前在代表性浏览器与微信真机复核加载和分包行为 |
