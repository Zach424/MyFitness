...
| R-009 | H5 入口仍超过 webpack 建议警告值，双端包体余量仍需持续保护                      | 中   | H5 最大异步块已降至 151,816/160,000 字节，WeApp 总量已降至 1,108,179/1,109,000 字节；预算已向下收紧，封闭测试前仍须在代表性浏览器与微信真机复核加载、缓存和分包行为       |
